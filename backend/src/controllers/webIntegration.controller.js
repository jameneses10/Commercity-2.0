...
async function adminProducts(req,res,next){try{res.json(successResponse('Productos administrativos obtenidos correctamente.',await service.adminProducts(req.query)));}catch(e){next(e)}}
