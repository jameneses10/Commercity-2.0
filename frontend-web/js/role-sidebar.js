const MENUS = {
  ...
  vendedor: {
    ...
    items: [
      ...
      { key: 'devoluciones', label: 'Devoluciones', href: 'vendedor-devoluciones.html', icon: 'cc-return-request.svg', routes: ['vendedor-devoluciones.html'] },
  ...
  administrador: {
    ...
    items: [
      ...
      { key: 'devoluciones', label: 'Devoluciones', href: 'admin-devoluciones.html', icon: 'cc-return-request.svg', routes: ['admin-devoluciones.html'] },
...
const ROUTE_ROLES = {
  ...
  'admin-devoluciones.html': 'administrador',
  ...
  'vendedor-devoluciones.html': 'vendedor',
